"""
Django settings for solar_energy_game_46309 project.
...
ROOT_URLCONF = 'solar_energy_game_46309.urls'
...
WSGI_APPLICATION = 'solar_energy_game_46309.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solar_energy_game_46309 API",
    "DESCRIPTION": "API documentation for solar_energy_game_46309 App",
    "VERSION": "v1",
}
